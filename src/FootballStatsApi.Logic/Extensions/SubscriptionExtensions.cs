...
namespace FootballStatsApi.Logic.Extensions
{
    ...
    {
        public static Models.Subscription ToModel(this Entities.Subscription entity)
        {
        ...
        public static Entities.Subscription ToEntity(this Models.Subscription model)
        {
        ...
        public static IEnumerable<Models.Subscription> ToModels(this IEnumerable<Entities.Subscription> entities)
        {
        ...
        public static IEnumerable<Entities.Subscription> ToEntities(this IEnumerable<Models.Subscription> models)
        {
